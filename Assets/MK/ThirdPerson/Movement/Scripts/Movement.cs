    ...
    public class Movement : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (stuckCorrection && inAir && Vector3.Distance(transform.position, lastUpdatePos) <= STUCK_CORRECTION_DISTANCE)
            {
                ...
                rb.AddForce(correctionDirection * speed * 0.5f, ForceMode.VelocityChange);
            }
        ...
        private void InternalMove()
        {
            ...
            {
                transform.forward = Vector3.Lerp(transform.forward, rb.velocity.normalized, Time.deltaTime * 20f);
